...
#         },
#         events=[],
#         current_conditions={"weather": "clear", "time_of_day": "morning"},
#         npcs={
#             "merchant": {"location": "town_square", "status": "working"},
#             "guard": {"location": "town_square", "status": "patrolling"}
#         }
#     )
#     engine.initialize_world(initial_world_state)
...
#         history=[]
#     )
#     engine.initialize_character(character)
    
#     # Progress time
#     result = engine.progress_time(hours=1)
#     print("World progression result:", json.dumps(result, indent=2))
